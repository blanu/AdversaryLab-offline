...
def updateTestAdversary(adversary, model, positive, negative, old, feature):
...
for ad in ads:
  ...
  positive=parts[0]
  negative=parts[1]
  updateTestAdversary(ad, model, positive, negative, old, feature)
